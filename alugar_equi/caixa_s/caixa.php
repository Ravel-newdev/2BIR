...
if (isset($_POST['submit'])) {
    ...
    $testador = $conect -> query("SELECT * FROM reservas WHERE produto = '$produto'");
    ...
    $result = mysqli_query($conect, "INSERT INTO reservas(nome,produto,data_reserva,aula_reserva) VALUES('$nome','$produto','$dr','$opcao_string')");
